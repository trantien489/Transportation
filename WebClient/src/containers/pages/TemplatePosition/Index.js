...
import { getAllTemplatePositionAction, changeStatusTemplatePositionAction, deleteTemplatePositionAction } from '../../../actions/templatePosition';
import { GridView } from '../../../components/gridView/gridView';
class TemplatePosition extends Component {
    constructor(props) {
        super(props);
...
const mapStateToProps = state => ({
    getAllModel: state.getAllTemplatePositionReducer,
    changeStatusModel: state.changeStatusTemplatePositionReducer,
    deleteModel: state.deleteTemplatePositionReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllTemplatePositionAction,
    changeStatusAction: changeStatusTemplatePositionAction,
    deleteAction: deleteTemplatePositionAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(TemplatePosition));