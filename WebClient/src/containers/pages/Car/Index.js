...
import { getAllCarAction, changeStatusCarAction, deleteCarAction } from '../../../actions/car';
...
class Car extends Component {
    ...
    render() {
        ...
        let disableColumns = ['CapacityId'];//['Id','Status'];
...
const mapStateToProps = state => ({
    getAllModel: state.getAllCarReducer,
    changeStatusModel: state.changeStatusCarReducer,
    deleteModel: state.deleteCarReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllCarAction,
    changeStatusAction: changeStatusCarAction,
    deleteAction: deleteCarAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(Car));