...
import { getAllPromotionAction, changeStatusPromotionAction, deletePromotionAction } from '../../../actions/promotion';
        ...
        if (getAllModel.isLoading) {
            ...
            if (hasRecordsActionReducer(getAllModel)) {
                return <GridView
                    ...
                    records={getAllModel.responseData.Data.Records.map(item=> {delete item.PromotionDetail; return item;})}
...
const mapStateToProps = state => ({
    getAllModel: state.getAllPromotionReducer,
    changeStatusModel: state.changeStatusPromotionReducer,
    deleteModel: state.deletePromotionReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllPromotionAction,
    changeStatusAction: changeStatusPromotionAction,
    deleteAction: deletePromotionAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(Promotion));