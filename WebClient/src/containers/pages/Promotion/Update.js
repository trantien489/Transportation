...
import { getByIdPromotionAction, addPromotionAction, editPromotionAction } from '../../../actions/promotion';
...
class PromotionUpdate extends Component {
    constructor(props) {
        ...
        let fields = [
            ...
            new InputField("Discount", ControlType.Text,'',true),
            new InputField("FromDate", ControlType.DateTime, formatDateTimeToString(new Date()),true),
            new InputField("ToDate", ControlType.DateTime, formatDateTimeToString(new Date()),true),
            new InputField("GroupProductId", ControlType.Text,'',true),
...
const mapStateToProps = state => ({
    getByIdModel: state.getByIdPromotionReducer,
    addModel: state.addPromotionReducer,
    editModel: state.editPromotionReducer,
});
const mapDispatchToProps = {
    getByIdAction: getByIdPromotionAction,
    addAction: addPromotionAction,
    editAction: editPromotionAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(PromotionUpdate));