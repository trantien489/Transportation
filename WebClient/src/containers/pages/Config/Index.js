...
import { getAllConfigAction, changeStatusConfigAction, deleteConfigAction } from '../../../actions/config';
...
const mapStateToProps = state => ({
    getAllModel: state.getAllConfigReducer,
    changeStatusModel: state.changeStatusConfigReducer,
    deleteModel: state.deleteConfigReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllConfigAction,
    changeStatusAction: changeStatusConfigAction,
    deleteAction: deleteConfigAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(Config));