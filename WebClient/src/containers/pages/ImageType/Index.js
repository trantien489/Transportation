...
import { getAllImageTypeAction, changeStatusImageTypeAction, deleteImageTypeAction } from '../../../actions/imageType';
...
const mapStateToProps = state => ({
    getAllModel: state.getAllImageTypeReducer,
    changeStatusModel: state.changeStatusImageTypeReducer,
    deleteModel: state.deleteImageTypeReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllImageTypeAction,
    changeStatusAction: changeStatusImageTypeAction,
    deleteAction: deleteImageTypeAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(ImageType));