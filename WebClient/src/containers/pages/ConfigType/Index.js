...
import { getAllConfigTypeAction, changeStatusConfigTypeAction, deleteConfigTypeAction } from '../../../actions/configType';
...
const mapStateToProps = state => ({
    getAllModel: state.getAllConfigTypeReducer,
    changeStatusModel: state.changeStatusConfigTypeReducer,
    deleteModel: state.deleteConfigTypeReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllConfigTypeAction,
    changeStatusAction: changeStatusConfigTypeAction,
    deleteAction: deleteConfigTypeAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(ConfigType));