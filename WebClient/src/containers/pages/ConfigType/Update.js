...
import { getByIdConfigTypeAction, addConfigTypeAction, editConfigTypeAction } from '../../../actions/configType';
...
class ConfigTypeUpdate extends Component {
    constructor(props) {
        super(props);
        let fields = [
            //Default fields
...
const mapStateToProps = state => ({
    getByIdModel: state.getByIdConfigTypeReducer,
    addModel: state.addConfigTypeReducer,
    editModel: state.editConfigTypeReducer,
});
const mapDispatchToProps = {
    getByIdAction: getByIdConfigTypeAction,
    addAction: addConfigTypeAction,
    editAction: editConfigTypeAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(ConfigTypeUpdate));