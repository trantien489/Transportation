...
import { getAllRolesAction, changeStatusRoleAction, deleteRoleAction } from '../../../actions/role';
...
const mapStateToProps = state => ({
    getAllModel: state.getAllRolesReducer,
    changeStatusModel: state.changeStatusRoleReducer,
    deleteModel: state.deleteRoleReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllRolesAction,
    changeStatusAction: changeStatusRoleAction,
