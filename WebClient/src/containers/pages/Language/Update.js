...
import { getByIdLanguageAction, addLanguageAction, editLanguageAction, checkUniqueLanguageAction } from '../../../actions/language';
...
import { isDefaultModels } from '../../../contants/staticData';
class LanguageUpdate extends Component {
    constructor(props) {
        super(props);
        let fields = [
            //Default fields
            ...
            new InputField("ResourceKey", ControlType.Text, '', false),
            new InputField("IsDefault", ControlType.CheckBox, false, false, null, null, null, isDefaultModels),
    ...
    componentDidMount() {
        ...
        this.props.checkUniqueAction('?name=tuan');
    }
...
const mapStateToProps = state => ({
    getByIdModel: state.getByIdLanguageReducer,
    addModel: state.addLanguageReducer,
    editModel: state.editLanguageReducer,
    checkUniqueModel: state.checkUniqueReducer,
});
const mapDispatchToProps = {
    getByIdAction: getByIdLanguageAction,
    addAction: addLanguageAction,
    editAction: editLanguageAction,
    checkUniqueAction: checkUniqueLanguageAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(LanguageUpdate));