...
import { getAllUsersAction, changeStatusUserAction, deleteUserAction } from '../../../actions/user';
...
class User extends Component {
    ...
    render() {
        ...
        let disableColumns = ['Password', 'PictureUrl','FacebookId'];//['Id','Status'];
...
const mapStateToProps = state => ({
    getAllModel: state.getAllUsersReducer,
    changeStatusModel: state.changeStatusUserReducer,
    deleteModel: state.deleteUserReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllUsersAction,
    changeStatusAction: changeStatusUserAction,
