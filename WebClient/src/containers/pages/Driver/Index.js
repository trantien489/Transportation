...
import { getAllDriverAction, changeStatusDriverAction, deleteDriverAction } from '../../../actions/driver';
...
class Driver extends Component {
    ...
    render() {
        ...
        let disableColumns = ['DriverTypeId'];//['Id','Status'];
...
const mapStateToProps = state => ({
    getAllModel: state.getAllDriverReducer,
    changeStatusModel: state.changeStatusDriverReducer,
    deleteModel: state.deleteDriverReducer,
});
//Phát đi tính hiệu thông qua action (để lấy data từ api)
const mapDispatchToProps = {
    getAllAction: getAllDriverAction,
    changeStatusAction: changeStatusDriverAction,
    deleteAction: deleteDriverAction,
};
export default translate()(connect(mapStateToProps, mapDispatchToProps)(Driver));