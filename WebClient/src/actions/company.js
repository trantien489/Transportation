...
//GETALL_SELECT
export const companyGetAllSelectAction = createAction(COMPANY.GETALL_SELECT);
export const companyGetAllSelectSuccessAction = createAction(COMPANY.GETALL_SELECT_SUCCESS);
export const companyGetAllSelectFailureAction = createAction(COMPANY.GETALL_SELECT_FAILURE);