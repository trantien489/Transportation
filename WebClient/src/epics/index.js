...
import { getAllTransportationEpic, changeStatusTransportationEpic, deleteTransportationEpic, addTransportationEpic, editTransportationEpic, getByIdTransportationEpic, generateMoneyTransportationEpic, transportationFilterEpic, transportationUpdateMoneyEpic } from '../epics/transportationEpic';
...
import { getAllPriceEpic, changeStatusPriceEpic, deletePriceEpic, addPriceEpic, editPriceEpic, getByIdPriceEpic, priceFilterEpic, priceGetAllSelectEpic, priceUpdateMultipleEpic } from '../epics/priceEpic';
...
const rootEpic = combineEpics(
    ...
    getAllTransportationEpic, changeStatusTransportationEpic, deleteTransportationEpic, addTransportationEpic, editTransportationEpic, getByIdTransportationEpic, generateMoneyTransportationEpic, transportationFilterEpic, transportationUpdateMoneyEpic,
    ...
    getAllPriceEpic, changeStatusPriceEpic, deletePriceEpic, addPriceEpic, editPriceEpic, getByIdPriceEpic,priceFilterEpic, priceUpdateMultipleEpic,
    
    reportBangkeEpic, reportCheckBangkeEpic,

    getAllPriceAdjustmentEpic, changeStatusPriceAdjustmentEpic, deletePriceAdjustmentEpic, addPriceAdjustmentEpic, editPriceAdjustmentEpic, getByIdPriceAdjustmentEpic, priceGetAllSelectEpic
